...
const UsersView = () => {
    ...
    return (
        <div>
                ...
                <div className='flex flex-col items-center flex-wrap max-w-[100vw] min-h-[95vh] mt-5'>
                    <div className='flex w-[55vw] h-[8vh] flex-row mb-4 items-end'>
                        <div className="h-[8vh] flex items-end">
                            <select name="cars" id="cars" onChange={(e) => setOption(e.target.value)} className="border-2 border-lg border-gray-700 h-[6vh] w-[8vw] flex-shrink-0 z-10 inline-flex items-center py-2.5 px-4 text-sm font-medium text-center rounded-l-lg focus:outline-none text-white capitalize ">
            ...
            sm:w-[43vw] w-[40vw] h-[6vh] block p-2.5 z-20 text-sm text-gray-900 rounded-r-lg focus:ring-blue-500 placeholder-gray-400 text-white' type="text" name="add" id="add" value={text} onChange={(e) => setText(e.target.value)} placeholder="search for users" autoComplete='off' />
                        </div>
                    </div>
