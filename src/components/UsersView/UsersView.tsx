                ...
                <div className='flex flex-col items-center flex-wrap max-w-[100vw] min-h-[95vh] mt-5'>
                    <div className='flex w-[55vw] h-[8vh] flex-row justify-center items-end'>
                        <div className="h-[8vh] flex items-center">
                            <select name="cars" id="cars" onChange={(e) => setOption(e.target.value)} className="rounded-lg mt-1 h-[4vh] mr-2">
                        ...
                        <div className='flex flex-col mb-4 w-[45vw]'>
                            ...
                            <input className='2xl:w-[47vw] xl:w-[46vw] lg:w-[45vw]
            sm:w-[43vw] w-[40vw]  rounded-sm p-2' type="text" name="add" id="add" value={text} onChange={(e) => setText(e.target.value)} autoComplete='false' />
                        </div>
                    </div>
